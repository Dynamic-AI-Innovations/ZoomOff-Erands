    ...
    <div className="flex min-h-screen items-center justify-center p-4 bg-zo-bg-dark">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <Image src="/logo.png" alt="ZoomOff Errands Errand Services" width={160} height={64} className="h-16 w-auto object-contain mx-auto mb-5" priority />
          <h1 className="font-display text-2xl font-bold text-white">Admin Console</h1>
          <p className="mt-1 text-sm text-gray-400">ZoomOff Errands internal operations — authorised access only</p>
        </div>
